...
%\usepackage{lua-visual-debug} % for debug box
% First
% rm -rf *.{aux,log,ltx,ind,idx,ilg,out,tmp,toc,atfi} & lualatex --draftmode "\PassOptionsToPackage{samples}{tkzexample}\input{TKZdoc-euclide-main.tex}"
% Second
% arara TKZdoc-euclide-main.tex
% \overfullrule=2cm

%\pgfkeys{%
  %tkzsavedcode/.cd,
  %prefix = tkzEuclide, outext = ltx}
%\makeatletter
%\ExamplePreamble{%
  %\\documentclass{standalone}\n
  %\\usepackage{tkz-euclide,tkz-fct}\n
  %\% Example \thetkzoutNr, Section \tkzref\n
  %\\begin{document}%
%}
%\ExamplePostamble{\\end{document}}

%\renewcommand{\marginfont}{\small}
%\renewcommand{\marginnotevadjust}{2.125ex}
%\AttachfileConfig{%
  %\typeout{Attach example file:}%
  %\marginnote{\raggedrightmarginnote\texttt{%
  %Ex\,{\FourierOrns X}\,\thetkzoutNr\,\guilsinglright\,\textattachfile[color=MidnightBlue,print=false]{#1}{\faFile*[regular]}}}%
%}
